 ...
 * @date       :
 * @function   :Draw a line between two points在两点之间画一条线
 ...
 * @date       :
 * @function   :Draw a rectangle画一个矩形
 ...
 * @date       :
 * @function   :Filled a rectangle填充矩形
 ...
 * @date       :
 * @function   :Draw a circle of specified size at a specified location在指定位置绘制指定大小的圆
 * @parameters :xc:the x coordinate of the Circular center 
                yc:the y coordinate of the Circular center 
								r:Circular radius
...
Draw a triangle at a specified position 在指定位置画一个三角形
 ...
 * @date       :
 * @function   :filling a triangle at a specified position在指定位置填充三角形
 * @parameters :x0:the bebinning x coordinate of the triangular edge 
                y0:the bebinning y coordinate of the triangular edge 
								x1:the vertex x coordinate of the triangular
								y1:the vertex y coordinate of the triangular
 ...
 * @date       :2018-08-09 
 * @function   :Display a single English character显示单个英文字符
